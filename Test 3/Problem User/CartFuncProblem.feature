Feature: Your Cart Page Functionality for problem_user

  Scenario : Verify Your Carts Page functionality for problem_user
      Given the user “problem_user” logs in successfully to "https://www.saucedemo.com/"
  ...
  Scenario : Verify Your Carts items are retained during page navigation for problem_user
      Given the logged in user “problem_user” has items in the cart
